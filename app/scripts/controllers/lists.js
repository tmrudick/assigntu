...
angular.module('assigntu')
  .controller('ListCtrl', ['$scope', '$routeParams', '$location', '$firebase', 'MessageBus',
    function($scope, $routeParams, $location, $firebase, MessageBus) {
  ...
  .controller('EditListCtrl', ['$scope', '$routeParams', '$location', '$firebase', 'MessageBus',
    function($scope, $routeParams, $location, $firebase, MessageBus) {
      var listId = $routeParams.id;
